    ...
    switch ( command )
    {
        case 'e' :
            ...
            CcspTraceInfo(("Connect to bus daemon...\n"));
            {
                ...
                if (g_Subsystem[0] != 0)
                {
                    _ansc_sprintf(CName, "%s%s", g_Subsystem, CCSP_COMPONENT_ID_MOTIONDETECTION);
                }
                else
                {
                    _ansc_sprintf(CName, "%s", CCSP_COMPONENT_ID_MOTIONDETECTION);
                }
                ...
                ssp_Mbi_MessageBusEngage
                    (
                        CName,
                        CCSP_MSG_BUS_CFG,
                        CCSP_COMPONENT_PATH_MOTIONDETECTION
                    );
            }
#endif
            ssp_create();
...
int main(int argc, char* argv[])
{
    ...
    pComponentName = CCSP_COMPONENT_NAME_MOTIONDETECTION;
    ...
    system("touch /tmp/motiondetection_initialized");
